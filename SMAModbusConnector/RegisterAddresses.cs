...
namespace SMAModbusConnector
{
    ...
    {
        public static readonly RegisterAddress Register_VersionNumber_30001 = new RegisterAddress(30001, RegisterAddressType.U32,
        ...
        public static readonly RegisterAddress Register_DeviceId_30003 = new RegisterAddress(30003, RegisterAddressType.U32,
            new RegisterDescription(Language.German,
                "SUSy-ID"),
            new RegisterDescription(Language.English, "Device ID of the WebBox"));

        public static readonly RegisterAddress Register_Serialnumber_30005 = new RegisterAddress(30005, RegisterAddressType.U32,
            new RegisterDescription(Language.German,
                "Seriennummer"),
        ...
        public static readonly RegisterAddress Register_DeviceClass_30051 = new RegisterAddress(30051, RegisterAddressType.U32,
            new RegisterDescription(Language.German,
                "Geräteklasse"),
            new RegisterDescription(Language.English, "Device class"));

        public static readonly RegisterAddress Register_TotalYieldInWh_30529 = new RegisterAddress(30529, RegisterAddressType.U32,
            new RegisterDescription(Language.German,
        ...
        public static readonly RegisterAddress Register_TotalYieldInKwh_30531 = new RegisterAddress(30531, RegisterAddressType.U32,
            new RegisterDescription(Language.German,
        ...
        public static readonly RegisterAddress Register_TotalYieldInMwh_30533 = new RegisterAddress(30533, RegisterAddressType.U32,
            new RegisterDescription(Language.German,
